...
interface Props {
  mouthHeight: number,
  onClickPlayer: React.MouseEventHandler<HTMLButtonElement> | undefined,
  blinkStatus: string
}
...
export const KanyeFace: React.FC<Props> = (props) => {
  return (
    <button tabIndex={1} onClick={props.onClickPlayer} style={{zIndex: '1'}} id='container' >
          ...
          <path id="right-eye-closed" style={{'opacity': `${props.blinkStatus==='closed'? '100' : '0'}`}} className='closed' d="M189.5 182C179.167 184.833 154.4 188.8 138 182" stroke="black" strokeWidth="2"/>
          <path id="right-eye-mid" style={{'opacity': `${props.blinkStatus==='mid'? '100' : '0'}`}}  className='mid' d="M137 183.502C147.456 176.062 172.694 165.229 190 181.419C185.673 185.883 169.016 192.55 137 183.502Z" fill="white" stroke="black" strokeWidth="2.17077"/>
          <path id="right-eyeball-mid" style={{'opacity': `${props.blinkStatus==='mid'? '100' : '0'}`}}  className='mid' d="M177.255 180.134C177.255 187.59 170.987 188 163.255 188C155.523 188 149.255 187.59 149.255 180.134C149.255 175 155.523 174 163.255 174C170.987 174 177.255 172.678 177.255 180.134Z" fill="black"/>
          <path id="right-eye" style={{'opacity': `${props.blinkStatus==='open'? '100' : '0'}`}} d="M136.824 185.785C147.316 172.218 172.641 152.464 190.008 181.986C185.666 190.127 168.951 202.283 136.824 185.785Z" fill="white" stroke="black" strokeWidth="2.17077"/>
          <ellipse id="right-eyeball" style={{'opacity': `${props.blinkStatus==='open'? '100' : '0'}`}}cx="163.255" cy="180.134" rx="14" ry="13.5" fill="black"/>
          <path id="left-eye-closed" style={{'opacity': `${props.blinkStatus==='closed'? '100' : '0'}`}}  className='closed' d="M34.5 180.5C44.8333 183.333 69.6 187.3 86 180.5" stroke="black" strokeWidth="2"/>
          <path id="left-eye-mid" style={{'opacity': `${props.blinkStatus==='mid'? '100' : '0'}`}}  className='mid' d="M35 182.181C42.129 175.253 62.3097 165.553 86 182.181C77.5914 186.572 55.6194 192.72 35 182.181Z" fill="white" stroke="black" strokeWidth="2.17077"/>
          <path id="left-eyeball-mid" style={{'opacity': `${props.blinkStatus==='mid'? '100' : '0'}`}}  className='mid' d="M75.2552 182.134C75.2552 190.142 69.0081 188 61 188C52.9919 188 46.2552 188 46.2552 182.134C46.2552 174.126 50.4919 172.5 58.5 172.5C66.5081 172.5 75.2552 174.126 75.2552 182.134Z" fill="black"/>
          <path id="left-eye" style={{'opacity': `${props.blinkStatus==='open'? '100' : '0'}`}} d="M34.2552 185.785C41.3101 172.942 61.2812 154.96 84.7255 185.785C76.4042 193.926 54.6604 205.322 34.2552 185.785Z" fill="white" stroke="black" strokeWidth="2.17077"/>
          <path id="left-eyeball" style={{'opacity': `${props.blinkStatus==='open'? '100' : '0'}`}} d="M75.2552 182.134C75.2552 190.142 68.7633 196.634 60.7552 196.634C52.747 196.634 46.2552 190.142 46.2552 182.134C46.2552 174.126 49.9919 168.5 58 168.5C66.0081 168.5 75.2552 174.126 75.2552 182.134Z" fill="black"/>
